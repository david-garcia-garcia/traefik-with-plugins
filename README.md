...
labels:
  ...
  - "traefik.http.middlewares.my-crowdsecfork.plugin.crowdsecfork.bouncerEnabled=true"
  - "traefik.http.middlewares.my-crowdsecfork.plugin.crowdsecfork.lapiEnabled=true"
