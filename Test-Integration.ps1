...
<#
.SYNOPSIS
    Runs integration tests for the Traefik with Plugins setup
...
try {
    Write-Host ""
    Write-Host "🚀 Traefik with Plugins Integration Test Runner" -ForegroundColor $Colors.Info
